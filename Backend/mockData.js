...
const profiles = [
  {
    ...
    userId: userIds[0],
    name: "Aaditya Singh",
    profileImage: { url: "https://i.pravatar.cc/150?img=3" },
    bannerImage: {
    ...
    experience: [
      {
        ...
        description: "Worked on full-stack projects.",
      },
    ],
    followerCount: 2,
    connCount: 2,
  ...
  },
  {
    ...
    userId: userIds[1],
    name: "Jane Doe",
    profileImage: { url: "https://i.pravatar.cc/150?img=4" },
    bannerImage: {
      url: "https://tse1.mm.bing.net/th?id=OIP.SqkKcPmn7j_ats47Zt8NKAHaCq&pid=Api&P=0&h=180",
    },
    headline: "Frontend Dev",
    about: "React enthusiast.",
  ...
  },
  {
    ...
    userId: userIds[2],
    name: "John Smith",
    profileImage: { url: "https://i.pravatar.cc/150?img=5" },
    bannerImage: {
      url: "https://tse1.mm.bing.net/th?id=OIP.SqkKcPmn7j_ats47Zt8NKAHaCq&pid=Api&P=0&h=180",
    },
    headline: "Backend Dev",
    about: "Node.js & MongoDB.",
  ...
  },
  {
    ...
    userId: userIds[3],
    name: "Demo User",
    profileImage: { url: "https://i.pravatar.cc/150?img=6" },
    bannerImage: {
      url: "https://tse1.mm.bing.net/th?id=OIP.SqkKcPmn7j_ats47Zt8NKAHaCq&pid=Api&P=0&h=180",
    },
    headline: "Demo Account",
    about: "This is a demo user for login.",
    ...
    experience: [
      {
        ...
        description: "Testing the LinkedIn clone.",
      },
    ],
    followerCount: 0,
    connCount: 0,
...
const comments = [
  ...
  },
  {
    ...
    postId: postIds[3],
    author: userIds[3],
    text: "This is a comment from the demo user.",
    createdAt: new Date(),
  },
];
...
const jobs = [
  {
    ...
    location: "Remote",
    jobdescription: "Work on React apps.",
...
const applications = [
  {
    ...
    jobId: jobIds[0],
    applicant: userIds[1],
    answers: ["I love React!"],
    resume: { filename: "resume1.pdf", id: createObjectId() },
    status: "New",
    appliedAt: new Date(),
  },
];
